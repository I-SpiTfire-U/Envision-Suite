...
public sealed class InputFilter(Int32 stickDeadzone = 3500, Int32 triggerDeadzone = 10, Int32 jitterThreshold = 300, Int32 triggerJitterThreshold = 20)
{
  ...
  private Int16 _PrevLeftStickX;
  private Int16 _PrevLeftStickY;
  private Int16 _PrevRightStickX;
  private Int16 _PrevRightStickY;
  private Int16 _PrevLeftTrigger;
  private Int16 _PrevRightTrigger;
  ...
  public void Apply(InputState state, InputState output)
  {
    ...
    FilterStickRadial(state.LeftStickX, state.LeftStickY, ref _PrevLeftStickX, ref _PrevLeftStickY, out var leftX, out var leftY);
    output.LeftStickX = leftX;
    output.LeftStickY = leftY;

    FilterStickRadial(state.RightStickX, state.RightStickY, ref _PrevRightStickX, ref _PrevRightStickY, out var rightX, out var rightY);
